...
Configuration SQLInstall
{
    ...
    Node $AllNodes.where{ $_.Role.Contains("SqlServer") }.NodeName
    {
        ...
        File SQLServerIso
        {
            SourcePath = "$PackagePath\en_sql_server_2012_developer_edition_with_sp1_x64_dvd_1228540.iso"
...
SQLInstall -ConfigurationData configData.psd1 -PackagePath "$PackagePath" -WinSources "$WinSources"
